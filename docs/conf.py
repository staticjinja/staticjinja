...
sys.path.insert(0, os.path.abspath(".."))
import staticjinja  # noqa: E402 (ignore that import is not at top of file)
...
version = staticjinja.__version__
# The full version, including alpha/beta/rc tags.
release = staticjinja.__version__
...
man_pages = [
    ("index", "staticjinja", "staticjinja Documentation", ["Ceasar Bautista"], 1)
]
